...
public enum AccessEventType {
     ...
     */
    ACCESS_DENIED_SITUATION,
    /**
     * Acesso Negado por Validade do Cartão
     */
    ACCESS_DENIED_CARD_VALIDITY,
    /**
     * Acesso Negado Pelo Controle de Nível
     */
    ACCESS_DENIED_LEVEL_CONTROLER,
    /**
     ...
     */
    ACCESS_DENIED_ROLE_RANGE,
    /**
     * Acesso Negado Pela Faixa Horária do Local
     */
    ACCESS_DENIED_LOCAL_RANGE,
    /**
     ...
     */
    ACCESS_DENIED_NOT_PARKING_SPACE,
    /**
     * Acesso Sob Coação
     */
    ACCESS_COERCION,
     ...
     */
    ACCESS_DENIED_BIOMETRY,
    /**
     * Acesso Negado Formato de Cartão Inválido
     */
    ACCESS_DENIED_CARD_FORMAT_ERROR,
    /**
     * Acesso Negado Facility Code
     */
    ACCESS_DENIED_FACILITY_CODE,
    /**
     ...
     */
    ACCESS_DENIED_SECOND_CARD_NOT_PRESENTED,
    /**
     ...
     */
    ACCESS_DENIED_CREDENTIAL_NOT_FOUND,
    /**
     * Acesso Negado por Validade de Credencial
     */
    ACCESS_DENIED_CREDENTIAL_VALIDITY,
    /**
     * Acesso Negado por Formato Inválido da Credencial do Veículo
     */
    ACCESS_DENIED_INVALID_VEHICLE_CREDENTIAL_FORMAT,
    /**
     ...
     */
    ACCESS_DENIED_WAITING_VEHICLE,
    /**
     * Acesso Negado por Leitora que Não Valida Veículo
     */
    ACCESS_DENIED_READER_NOT_VALIDATE_VEHICLE,
    /**
     ...
     */
    ACCESS_DENIED_CUSTOM_VALIDATION,
    /**
